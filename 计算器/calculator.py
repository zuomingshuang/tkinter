...
tk.Button(root,text='=',command=func_EQL,width=4,height=3,bg='#FF34B3').grid(row=4,column=3,padx=1,rowspan=2,pady=1)
...
def func_POT():
    T1.insert(tk.END,'.')
tk.Button(root,text='0',command=func_0,width=12,height=1,bg='#EE7AE9').grid(row=5,column=0,columnspan=2,padx=1,pady=1)
